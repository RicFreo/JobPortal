				...
				<div class="col-md-4 col-md-offset-4 well">
					...
					<form method="post" action= "addpost.php">
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control" id="minimumsalary" name="minimumsalary" placeholder="Minimum salary" >
					  </div>
					  <div class="form-group">
						<label for="maximumsalary">Maximum Salary</label>
						<input type="text" class="form-control" id="maximumsalary" name="maximumsalary" placeholder="Maximum Salary">
					  </div>
					   <div class="form-group">
						<label for="experience">Experienced Required</label>
					   ...
					   <div class="form-group">
						...
						<input type="text" class="form-control" id="qualification" name="qualification" placeholder="Qualification Required Ex. IT or BM" required= "">
					  </div>
