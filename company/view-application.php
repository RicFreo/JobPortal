	  ...
	  <div class="panel panel-info">
        <div class = "panel-heading">User Application</div>
			<div class="panel-body">
				<?php
			$sql ="SELECT * FROM tblapply_job_post INNER JOIN tbusers ON tblapply_job_post.id_user=tbusers.id_user WHERE tbusers.id_user='$_GET[id_user]'
			AND tblapply_job_post.id_jobpost='$_GET[id_jobpost]'";
			...
			if($result->num_rows > 0)
			{
				...
				{?>
					...
					<p>Contactno.: <?php echo $row['contactno'];?></p>
